...
function displayPage(page) {
  ...
  venuesToShow.forEach(venue => {
    ...
    const totalCost = useEstimate ? (venue.price_per_day_guest * parseInt(document.getElementById("venueDayGuests").value)) + 
                                   (venue.price_per_evening_guest * parseInt(document.getElementById("venueEveningGuests").value)) +
                                   (venue.venue_hire || 0) : 0;
...
<p><strong>Venue Hire:</strong> ${venue.display_venue_hire}</p>
